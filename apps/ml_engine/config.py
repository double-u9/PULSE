...
MODEL      = _apply_overrides(ModelConfig,      _YAML)
BACKTEST   = _apply_overrides(BacktestConfig,   _YAML)
PATHS      = _apply_overrides(PathConfig,       _YAML)
EXPERIMENT = _apply_overrides(ExperimentConfig, _YAML)
SEED       = 42
